...
Post.create(title: "Cómo aumentar tu audiencia en Medium", description:"Paso uno: Cambia tu mentalidad
...
Post.create(title: "El arte y la ciencia de las etiquetas", description:"Las etiquetas son una parte importante de la experiencia de Medium. Ya sea publicando una pieza original o respondiendo a otro escritor, las etiquetas son clave para ayudar a que nuevos lectores descubran tu trabajo.
